...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "voc_2007_train_cocostyle": {
            ...
            "ann_file": "VOCdevkit/VOC2007/Annotations/pascal_train2007.json"
        },
        "voc_2007_val": {
            "data_dir": "VOCdevkit/VOC2007",
            "split": "val"
        ...
        "voc_2007_val_cocostyle": {
            "img_dir": "VOCdevkit/VOC2007/JPEGImages",
            "ann_file": "VOCdevkit/VOC2007/Annotations/pascal_val2007.json"
        },
        "voc_2007_test": {
            "data_dir": "VOCdevkit/VOC2007",
            "split": "test"
        ...
        'voc_2007_test_subset': {
            "data_dir": "VOCdevkit/VOC2007",
            "split": "test",
            "desired_classes_subset": ('aeroplane','bicycle', 'bird', 'car', 'cat', 'dog', 'person')
        },
        ...
        "voc_2012_train_cocostyle": {
            ...
            "ann_file": "VOCdevkit/VOC2012/Annotations/pascal_train2012.json"
        },
        "voc_2012_val": {
            "data_dir": "VOCdevkit/VOC2012",
            "split": "val"
        ...
        "voc_2012_val_cocostyle": {
            "img_dir": "VOCdevkit/VOC2012/JPEGImages",
            "ann_file": "VOCdevkit/VOC2012/Annotations/pascal_val2012.json"
        },
        "amds_train": {
            "data_dir": "amds",
            "split": "train",
        ...
        "cityscapes_detection_rainy_train": {
            "data_dir": "CityScapes",
            "split": "rain_train"
        },
        "cityscapes_1_00_detection_rainy_train": {
            "data_dir": "cityscapes_1_00",
            "split": "rain_train"
        },
        "cityscapes_1_01_detection_rainy_train": {
            "data_dir": "cityscapes_1_01",
            "split": "rain_train"
        },
        "cityscapes_1_02_detection_rainy_train": {
            "data_dir": "cityscapes_1_02",
            "split": "rain_train"
        },
        "cityscapes_detection_rainy_val": {
            "data_dir": "CityScapes",
            "split": "rain_val"
        },
    ...
    def get(name):
        if "subset" in name:
            ...
            args = dict(
                ...
                anno_dir=os.path.join(data_dir, attrs["ann_file"]),
                split=attrs["split"],
            )
            return dict(
                factory="BDD100KDetDataset",
                args=args,
            )
        elif "kitti" in name:
            data_dir = DatasetCatalog.DATA_DIR
