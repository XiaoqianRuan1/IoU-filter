...
#_C.MODEL.BACKBONE.CONV_BODY = "VGG16-C5"
#_C.MODEL.BACKBONE.CONV_BODY = "MNV2-FPN-RETINANET"
...
_C.MODEL.SELF_SUPERVISOR.TTA_ITERATIONS = 1
_C.MODEL.SELF_SUPERVISOR.TTA_WARMUP = 0
_C.MODEL.SELF_SUPERVISOR.TTA_BREAKPOINTS = ()
...
#-------------------------------------------------------------------------------#
_C.MODEL.VGG16 = CN()
_C.MODEL.VGG16.STEM_FUNC = "StemWithFixedBatchNorm"
_C.MODEL.VGG16.BACKBONE_OUT_CHANNELS = 256*4
_C.MODEL.VGG16.STEM_OUT_CHANNELS = 64
...
_C.MODEL.SEMISUP = CN()
_C.MODEL.SEMISUP.TRAINING = True
_C.MODEL.SEMISUP.BBOX_THRESHOLD = 0.7
_C.MODEL.SEMISUP.TTA_ITERATIONS = 10
_C.MODEL.SEMISUP.TEACHER_UPDATE = 1
_C.MODEL.SEMISUP.KEEP_RATE = 0.5

_C.MODEL.SEMI_SUPERVISED = CN()
_C.MODEL.SEMI_SUPERVISED.TEACHER_ITER=1
_C.MODEL.SEMI_SUPERVISED.KEEP_RATE = 0.9996
