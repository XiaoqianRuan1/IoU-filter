...
def convert_to_meta(net):
    ...
    if(G_RCNN):
      ...
      meta_net.process_pseudo_label_uncertainty = net.process_pseudo_label_uncertainty
      meta_net.generate_auged_boxes = net.generate_auged_boxes
      meta_net.compute_with_uncertainty = net.compute_with_uncertainty
      meta_net.filter_invalid = net.filter_invalid
      meta_net.generate_pseudo = net.generate_pseudo
      meta_net.generate_pseudo_result = net.generate_pseudo_result
      meta_net.aug_roi = net.aug_roi
      meta_net.get_pseudo_labels = net.get_pseudo_labels
