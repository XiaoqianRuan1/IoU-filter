...
@registry.BACKBONES.register("VGG16-C4")
@registry.BACKBONES.register("VGG16-C5")
def build_vgg16_backbone(cfg):
    body = vgg16.VGG16(cfg)
    model = nn.Sequential(OrderedDict([("body", body)]))
    model.out_channels = cfg.MODEL.VGG16.BACKBONE_OUT_CHANNELS
    return model
