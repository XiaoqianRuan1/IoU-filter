...
def main():
    ...
    source_model = build_detection_model(cfg)
    source_model.to(cfg.MODEL.DEVICE)
    ...
    checkpointer = DetectronCheckpointer(cfg, source_model, save_dir=output_dir)
    weight_checkpointer = DetectronCheckpointer(cfg, model, save_dir=output_dir)
    ckpt = cfg.MODEL.WEIGHT if args.ckpt is None else args.ckpt
    _ = checkpointer.load(ckpt, use_latest=args.ckpt is None)
    _ = weight_checkpointer.load(cfg.MODEL.WEIGHT)
    ...
    for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
        evaluations = pseudo_inference(source_model,
                                model,
                                data_loader_val,
